...
a = Analysis(
    ...
    datas=[
        ...
        (str(repo_root / "batch_optimize_maximum.py"), "."),
        (str(repo_root / "calibrate_maximum_profiles.py"), "."),
        (str(repo_root / "render_previews.py"), "."),
        (str(maximum_package), "maximum_optimizer"),
        (
            str(repo_root / "third_party" / "meshoptimizer" / "LICENSE.md"),
