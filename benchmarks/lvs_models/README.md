...
`blender_adaptive_v1.json` freezes the Task 7 checkpoints plus the Task 8B corpus expansion.
Actual StudioMDL compiled bytes select candidates;
...
Every audit fallback preserves the complete SMD byte-for-byte and records matching source/output
hashes. The post-hardening r0.40 results are:

| family | candidate | frozen b050 | delta vs b050 |
|---|---:|---:|---:|
| Pontiac wheel | 502,779 | 633,089 | -20.58% |
| Dodge Charger | 13,326,209 | 14,738,984 | -9.59% |
| Dodge Monaco police | 13,817,692 | 11,716,117 | +17.94% |
| Toyota Supra | 10,520,251 | 11,579,284 | -9.15% |
| Nissan Skyline GTR32 | 6,802,199 | 6,630,288 | +2.59% |
| VW Beetle | 4,185,594 | 3,612,514 | +15.86% |
| VW Touareg | 6,203,485 | 4,848,924 | +27.94% |

This is a mixed compiled-byte result, not a promoted winner. Four of five pressure families ran;
Ford Fairlane remains the explicit duplicate-animation non-roundtrippable control. Wheel QC-aware
textures resolved, but bodygroups occlude internal detail.
